    ...
    internal sealed class Configuration : DbMigrationsConfiguration<GeekPeekedDbContext>
    {
        ...
        protected override void Seed(GeekPeekedDbContext context)
        {
            ...
            var academyAwardsNominees = new List<AcademyAwardsNominee>
            {
                ...
                new AcademyAwardsNominee { AcademyAwardsCategoryId = 01, NomineeText = "Fences", SortOrder = 0, CreatedBy ="Configuration.Seed()" },
                new AcademyAwardsNominee { AcademyAwardsCategoryId = 01, NomineeText = "Hacksaw Ridge", SortOrder = 0, CreatedBy ="Configuration.Seed()" },
                new AcademyAwardsNominee { AcademyAwardsCategoryId = 01, NomineeText = "Hell or High Water", SortOrder = 0, CreatedBy ="Configuration.Seed()" },
                new AcademyAwardsNominee { AcademyAwardsCategoryId = 01, NomineeText = "Hidden Figures", SortOrder = 0, CreatedBy ="Configuration.Seed()" },
                new AcademyAwardsNominee { AcademyAwardsCategoryId = 01, NomineeText = "La La Land", SortOrder = 0, CreatedBy ="Configuration.Seed()" },
                new AcademyAwardsNominee { AcademyAwardsCategoryId = 01, NomineeText = "Lion", SortOrder = 0, CreatedBy ="Configuration.Seed()" },
                new AcademyAwardsNominee { AcademyAwardsCategoryId = 01, NomineeText = "Manchester By the Sea", SortOrder = 0, CreatedBy ="Configuration.Seed()" },
                new AcademyAwardsNominee { AcademyAwardsCategoryId = 01, NomineeText = "Moonlight", SortOrder = 0, CreatedBy ="Configuration.Seed()" },
